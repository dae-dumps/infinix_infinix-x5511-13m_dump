...
BUILD_PRELOADER = yes
BUILD_UBOOT = no
CUSTOM_BUILD_VERNO = CY-X5511-H3716
...
CUSTOM_HAL_CAM_CAL = s5k3l8_eeprom s5k3h7_otp dummy_eeprom
CUSTOM_HAL_COMBO = mt6735
CUSTOM_HAL_EEPROM = dummy_eeprom
CUSTOM_HAL_FLASHLIGHT = dummy_flashlight
CUSTOM_HAL_IMGSENSOR = s5k3h7yx_mipi_raw s5k3l8_mipi_raw ov5695_mipi_raw ov5695sunwin_mipi_raw s5k3l8b_mipi_raw
CUSTOM_HAL_LENS = dw9800af dw9800baf dw9714af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS =
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3h7yx_mipi_raw s5k3l8_mipi_raw s5k3l8b_mipi_raw
CUSTOM_HAL_MAIN_LENS = dw9800af dw9714af dw9800baf
CUSTOM_HAL_MSENSORLIB = memsicd3524x mmc328x akm8975 ami304 yamaha530 mag3110 akmd8963 bmm050 mc6420 mmc3416x s62xd lsm303md hscdtd006 qmc5983 akmd09911 mc64xx bmm056 mc41xx
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_BACKUP_LENS = 
CUSTOM_HAL_SUB_IMGSENSOR = ov5695_mipi_raw ov5695sunwin_mipi_raw
...
CUSTOM_KERNEL_CAM_CAL = s5k3l8_eeprom s5k3h7_otp dummy_eeprom
...
CUSTOM_KERNEL_IMGSENSOR = s5k3h7yx_mipi_raw s5k3l8_mipi_raw ov5695_mipi_raw ov5695sunwin_mipi_raw s5k3l8b_mipi_raw
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = dw9800af dw9800baf dw9714af dummy_lens
CUSTOM_KERNEL_MAGNETOMETER = yes
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_LENS = 
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k3h7yx_mipi_raw s5k3l8_mipi_raw s5k3l8b_mipi_raw
CUSTOM_KERNEL_MAIN_LENS = dw9800af dw9714af dw9800baf
CUSTOM_KERNEL_RTC = rtc
CUSTOM_KERNEL_SOUND = amp_6323pmic_spk
CUSTOM_KERNEL_SSW = ssw_single_v2
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_SUB_BACKUP_LENS =
CUSTOM_KERNEL_SUB_IMGSENSOR = ov5695_mipi_raw ov5695sunwin_mipi_raw
CUSTOM_KERNEL_SUB_LENS = dummy_lens
CUSTOM_KERNEL_TOUCHPANEL = GT1XX
CUSTOM_KERNEL_USB = mt6577
CUSTOM_KERNEL_VIBRATOR = vibrator
CUSTOM_MODEM = rlk6737_lwg_h3716_co_clock
...
#OS: add dirac by shuchenlin 20161031 start
MTK_BESLOUDNESS_SUPPORT = yes 
MTK_BESSURROUND_SUPPORT = yes 
#OS: add dirac by shuchenlin 20161031 end
...
MTK_BUILD_VERNO = X5511-H3716B-M-IN-190426V160
MTK_BWC_SUPPORT = yes
MTK_C2K_SUPPORT = no
...
# likang project macro control start
RLK_PROJECT=infinix_x556
RLK_PROJECT_NAME=x5511_h3716_b1
# likang project macro control end
#add by chesihu {
RLK_CAMERA_FRONT_MIRROR = yes
ARCSOFT_BURST_SUPPORT = yes
RLK_NIGHT_CHANGE_MODE = yes
RLK_VIDEO_QUALITY_720P_SUPPORT = yes
#add by chesihu }
#add by lilonglong on
RLK_INPUT_METHOD_DEFAULT = yes 
#add by lilonglong off
...
FINGERPRINT_SUPPORT_AFS121 = yes
#chenming add RJIL VOLTE SUPPORT
MTK_SIP_SUPPORT = no
MTK_MD_SBP_CUSTOM_VALUE=18

RLK_FINGERPRINT_SUPPORT = yes
#CREATE_PROJECT_INFO=2016032916570
#likang add Midtest
RLK_MIDTEST_SUPPORT = yes
# built-in apk
BUILD_3RDPARTY = yes
# likang add RLK_PHYSICAL_BUTTON_KEY
RLK_PHYSICAL_BUTTON_KEY_SUPPORT = yes

#add by liuyangyang PowerOff2.0 20160628
INFINIX_POWEROFF_1_0_SUPPORT = no
#end
#add by yang.li3@reallytek.com  20160620  fot manul focus start 
RLK_CAMERA_MANUAL_AF = yes
RLK_CAMERA_MANUAL_SHUTTER_SUPPORT= yes 
#add by yang.li3@reallytek.com  20160620  fot manul focus end
#rlk_Fandy.zhang_s
RLK_G345_LOWLIGHT = yes
RLK_G345_FACEBEAUTY = yes
#rlk_Fandy.zhang_e

#rlk_wuhao2
RLY_AUTO_FACTORY_RST = yes
#rlk_wuhao2
#OS: add dirac by shuchenlin 20161031 start
INF_DIRAC_SUPPORT = yes
#OS: add dirac by shuchenlin 20161031 end
#ADD [PPD] mingyuan.wang 2017.01.04 PPS close set no
MTK_PPS_SUPPORT = yes
#ADD [PPD] mingyuan.wang 2017.01.04 PPSend 
#xiangqiu.meng add for compass start 2016.11.17
XUI_REALLYTEK_COMPASS = yes
MTK_SHOW_MSENSOR_TOAST_SUPPORT = yes
#xiangqiu.meng add for compass end 2016.11.17
#infinix:add by jinbaoping 20170704 start 
MTK_INDIA_INCALL_SUPPORT=yes 
#infinix:add by jinbaoping 20170704 end
#add UserGuide-liuhaojie start
RLK_USERGUIDE_VERSION = x5511_h3716_b1_IN
#add UserGuide-liuhaojie end

#[PPD]added by hanhao lmk_boost 20170621 start @{
LMK_BOOST_SUPPORT=yes
#[PPD]added by hanhao lmk_boost 20170621 end @}
